...
pipeline {
    ...
    stage('SonarQube Inspection') {
        steps {
            withSonarQubeEnv('SonarQube') { 
                ...
                -Dsonar.host.url=http://172.31.60.14:9000 \
  ...
  post {
    always {
        ...
        slackSend channel: '#cicd-pipeline-project-jmbangah', //update and provide your channel name
